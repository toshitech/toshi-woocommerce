/**
 * Performs a request to the TOSHI API to fetch the modal configuration
 * using the credentials supplied for the purpose of validation.
 * Note: This is currently unfinished and can return false positives.
 */
(function($) {
  $(function() {
